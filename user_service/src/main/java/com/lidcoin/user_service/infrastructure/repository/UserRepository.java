...
/**
 * Interface de repository pour l'accès aux données des utilisateurs.
 * Étend JpaRepository pour fournir des opérations CRUD de base et des méthodes de requête spécifiques.
 * Définit des méthodes personnalisées pour la recherche d'utilisateurs par différents critères.
 */
@Repository
