...
/**
 * Classe de configuration qui charge des données initiales dans la base de données au démarrage de l'application.
 * Implémente CommandLineRunner pour exécuter du code au démarrage de l'application Spring Boot.
 * Crée des utilisateurs par défaut si la base de données est vide.
 */
@Component
