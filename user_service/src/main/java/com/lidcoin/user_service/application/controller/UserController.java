 ...
 * Fournit des endpoints pour la création, la lecture, la mise à jour et la suppression des utilisateurs.
 * Gère également les opérations liées aux rôles et au statut des utilisateurs.
 * Tous les endpoints sont préfixés par "/api/users".
 */
@RestController
